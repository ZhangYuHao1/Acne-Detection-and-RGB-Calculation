...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/test _wrinkle.yaml', help='data.yaml path')
    ...
    parser.add_argument('--nosave', action='store_true', help='only save final checkpoint') #default=True,
